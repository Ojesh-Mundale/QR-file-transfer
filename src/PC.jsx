...
const FRONTEND = window.location.origin;
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex flex-col p-2 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="relative z-10 w-full px-3">
          ...
          <div className="text-center mb-2 animate-fade-in">
            ...
            <p className="text-white/90 text-base typewriter">Seamless file sharing between devices</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-2 max-w-6xl mx-auto">
            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-6 transform transition-all duration-500 hover:shadow-purple-500/20 hover:shadow-3xl h-[600px]">
              <div className="flex flex-col items-center justify-center space-y-6 h-full">

                {/* Title */}
                <div className="text-center">
                  <h2 className="text-4xl font-bold text-gray-800 mb-2">Send Files</h2>
                  <p className="text-gray-600 text-lg">Scan QR code with your mobile</p>
                </div>
                ...
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-50 to-purple-50 text-indigo-700 px-4 py-3 rounded-full text-base font-medium shadow-sm border border-indigo-100">
                  <Smartphone className="w-6 h-6" />
                  Open camera and scan QR code
                </div>

                {/* Timer - Simple and Clean */}
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl px-6 py-4 shadow-sm border border-purple-100">
                  <div className="flex items-center gap-3">
                    <div className="bg-white p-2 rounded-full shadow-sm">
                      <Clock className="w-6 h-6 text-purple-500" />
                    </div>
                    <div>
                      <p className="text-base text-gray-600 font-medium">Session expires in</p>
            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 transform transition-all duration-500 hover:shadow-purple-500/20 hover:shadow-3xl h-[600px]">
              <div className="flex flex-col h-full">
                ...
                <div className="text-center pb-4 mb-4 border-b border-gray-200">
                  ...
                  <p className="text-gray-600 text-lg">Check for uploaded files</p>
                </div>
                ...
                {!fileReady ? (
                  ...
                  <div className="flex-1 flex flex-col space-y-6 animate-fade-in">
                    ...
                    <div className="text-center flex-shrink-0">
                      ...
                      <p className="text-gray-600 text-lg">Your file is ready</p>
                    </div>

                    {/* File Info */}
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-4 border-2 border-green-200 flex-shrink-0">
                      <div className="flex items-start gap-3">
                        <div className="bg-white p-1.5 rounded-lg shadow-sm">
                          <Download className="w-5 h-5 text-green-600" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-semibold text-gray-800 break-all">File Name: {fileName}</p>
                        </div>
                      </div>
                    </div>

                    {/* Action Buttons */}
                    <div className="flex flex-col items-center space-y-2 flex-1 justify-end">
                      <button
                        onClick={handleDownload}
                        className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2"
                      >
                      ...
                      <button
                        onClick={handlePrint}
                        className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2"
                      >
